...
Assume you have a folder with rttms from a single system

```{r}
myfolder="~/Documents/gitrepos/corstatana/system_eval/output_rttms/pipeline/v1/lda120_plda_voxceleb_babytrain/jsalt19_spkdet_babytrain_eval_test/"
